...
public class ResponseVO<T extends Serializable> implements Serializable {
    ...
    private static final long serialVersionUID = 3146377420203784752L;
    /**
     * 消息状态
     */
     ...
     * @return
     */
    public static <T> ResponseVO successInstance(T data) {
        ResponseVO res = successInstance();
        res.setData((Serializable) data);
        return res;
    }
    ...
    public <T> T getData(TypeReference<T> typeReference) {
        String jsonString = JSONUtil.toJsonStr(this.data);
        return JSONUtil.toBean(jsonString,typeReference,false);
    }
